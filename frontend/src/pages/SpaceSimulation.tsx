      ...
      <div className="pt-24 px-6 pb-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            {isLaunched && (
              <UnityViewer
                loaderUrl="/unity-build/Build/Build/Build.loader.js"
                dataUrl="/unity-build/Build/Build/Build.data.br"
                frameworkUrl="/unity-build/Build/Build/Build.framework.js.br"
                codeUrl="/unity-build/Build/Build/Build.wasm.br"
